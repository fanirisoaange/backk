...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->services = [];
        $this->normalizedIds = [
            '1_arraycache~gx8etuv' => '1_ArrayCache~gx8etuv',
        ...
        $this->fileMap = [
            ...
            'manager.product' => 'getManager_ProductService.php',
            ...
            'service.repository.product' => 'getService_Repository_ProductService.php',
        ...
        $this->privates = [
            ...
            'service.repository.product' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('KWTByYuDF9', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SH13MgjHe8', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YOqOGzxcet', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('krZek6xOlh', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kC5lY3MYcv', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('bee9439bf378df49211d382c2c9b4ca67387553d'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('bee9439bf378df49211d382c2c9b4ca67387553d');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'jms_di_extra.directories': $value = [
                0 => ($this->targetDirs[3].'\\app/../src'),
            ]; break;
            case 'jms_di_extra.cache_dir': $value = ($this->targetDirs[0].'/jms_diextra'); break;
            case 'jms_di_extra.doctrine_integration.entity_manager.file': $value = ($this->targetDirs[0].'/jms_diextra/doctrine/EntityManager_5d47a5de41182.php'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'secret' => 'bee9439bf378df49211d382c2c9b4ca67387553d',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => '',
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'bee9439bf378df49211d382c2c9b4ca67387553d',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5d47a5de41182_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
