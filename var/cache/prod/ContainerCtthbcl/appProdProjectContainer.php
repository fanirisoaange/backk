...
class appProdProjectContainer extends Container
{
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'jms_di_extra.doctrine_integration.entity_manager.file': $value = ($this->targetDirs[0].'/jms_diextra/doctrine/EntityManager_5d490f1ea27cc.php'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5d490f1ea27cc_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
